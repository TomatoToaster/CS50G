...
function love.load()
    ...
    -- TODO: muted for my sanity, undo this at the end or choose a better song
    -- kick off music
    ...
    -- initialize our global pause flag
    gIsPaused = false
...
function love.draw()
    ...
    if gIsPaused then
        love.graphics.draw(pauseIcon, VIRTUAL_WIDTH / 2 - 15, VIRTUAL_HEIGHT / 2 + 10, 0, 1, 1)
    end
