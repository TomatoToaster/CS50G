...
require 'src/states/entity/PlayerDancingState'
...
-- Some special custom setup for these
gTextures['flags']= love.graphics.newImage('graphics/flags.png')
gTextures['poles']= gTextures['flags']

gFrames['flags'] = GenerateQuadsFlags(gTextures['flags'])
gFrames['poles'] = GenerateQuadsPoles(gTextures['poles'])
