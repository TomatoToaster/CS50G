...
function PlayState:init()
    ...
    self.player = Player({
        ...
        stateMachine = StateMachine {
            ...
            ['dancing'] = function() return PlayerDancingState(self.player) end,
        },
    })
...
function PlayState:enter(params)
    -- Collect params and set default values if they're not provided
    local params = params or {}
    local width = params.width or START_WIDTH
    ...
    -- Loop through the tiles and make sure we are dropping under the first solid ground
